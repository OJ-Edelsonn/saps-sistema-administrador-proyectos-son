...
@Service
public class ProyectoServiceImpl extends GenericCrudServiceImpl<Proyecto>
  ...
  public List<Proyecto> buscar(String texto) {
    return StringUtils.hasText(texto)
        ? repository.findByTituloContainingIgnoreCaseOrLineaTematicaContainingIgnoreCase(
            texto, texto)
        : repository.findAll();
  }
}
