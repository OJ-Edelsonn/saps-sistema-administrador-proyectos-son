...
@Service
public class CalificacionServiceImpl extends GenericCrudServiceImpl<Calificacion> implements CalificacionService {
    ...
    public BigDecimal calcularNotaFinal(Calificacion calificacion) {
        ...
        for (DetalleCalificacion detalle : calificacion.getDetalles()) {
            ...
            BigDecimal proporcion = detalle.getPuntajeObtenido()
        ...
        return acumulado.multiply(BigDecimal.valueOf(20))
